        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(async position => {
                ...
                routingControl = L.Routing.control({
                    // ask the router to produce instructions in French when supported
                    ...
                    formatter: new L.Routing.Formatter({
                        language: 'fr', // request French formatting
                        units: 'metric'
                    }),
                    // create invisible markers for start/end so they don't appear on the map
                    createMarker: function (i, wp, nWps) {
                        // create a marker at the waypoint but invisible and non-interactive
                ...
                // Fallback: many routers don't translate all instruction strings.
                // Post-process visible instruction texts and replace English phrases by French.
                ...
                // Apply translation after routes are found / selected
